...
class DesniveisScreen extends StatefulWidget {
  @override
  _DesniveisScreenState createState() => _DesniveisScreenState();
}

class _DesniveisScreenState extends State<DesniveisScreen> {
      ...
      for (var object in trechosGlobal) {
        ...
        WriteButton writeButton = WriteButton(
          ...
          onChanged: (String value) {
            print(value);
            object.desniveis = double.parse(value);
        ...
        Row(
          ...
          children: [
            ...
            ForwardIconButton(
              size: size,
              onPressed: () =>
                  Navigator.pushNamed(context, 'tesCotovelosScreen'),
            ),
          ],
        ),
        LogoTr(size: size),
